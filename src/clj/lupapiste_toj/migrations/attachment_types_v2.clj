(ns lupapiste-toj.migrations.attachment-types-v2
  (:require [lupapiste-toj.migrations.attachment-type-utils :as utils]))

(def attachment-mapping
  ;; Copied from lupapalvelu.migration.attachment-type-mapping
...
(defn migrate-attachment-types [db]
  (utils/migrate-attachment-types db ["draft" "default-data"] attachment-mapping))
