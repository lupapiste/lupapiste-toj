(ns lupapiste-toj.migrations.core
  (:require [clojure.set :refer [difference]]
            ...
            [lupapiste-toj.migrations.update-ymp-default-data-for-attachment-types-v2 :refer [update-ymp-default-data]]
            [lupapiste-toj.migrations.update-ymp-drafts-for-attachment-types-v2 :refer [update-ymp-drafts]]
...
(def migrations
  {1 {:description "Adds :tila key to metadata under :liite and :asiakirja nodes"
   ...
   29 {:description "Update YMP default data for attachment types v2"
       :op          update-ymp-default-data}
   30 {:description "Update YMP drafts for attachment types v2"
       :op          update-ymp-drafts}
   })
